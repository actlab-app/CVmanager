...
it('only accepts http and https live project urls', function () {
    Livewire::test(PortfolioEditor::class)
        ->set('slug', 'invalid-live-url')
        ->set('translations.tr.title', 'Geçersiz URL')
        ->set('translations.en.title', 'Invalid URL')
        ->set('live_url', 'cvm.actlab.app')
        ->call('save')
        ->assertHasErrors(['live_url' => 'url']);

    Livewire::test(PortfolioEditor::class)
        ->set('slug', 'valid-live-url')
        ->set('translations.tr.title', 'Geçerli URL')
        ->set('translations.en.title', 'Valid URL')
        ->set('live_url', 'https://cvm.actlab.app?rt=test')
        ->call('save')
        ->assertHasNoErrors();
});
