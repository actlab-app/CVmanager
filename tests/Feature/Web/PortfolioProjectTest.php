...
it('shows public and private portfolio links on index and detail pages', function () {
    ...
    $privateProject = createPublishedPortfolioProject([
    ...
    $this->withSession(['locale' => 'tr'])
        ...
        ->assertSee('images/icons/live.svg')
        ->assertSee('images/icons/github.svg');
    ...
    $this->withSession(['locale' => 'tr'])
        ->get(route('portfolio.show', $privateProject))
        ->assertOk()
        ->assertSee(__('Bu proje açık kaynaklı değildir.'))
        ->assertSee(__('Detaylar için iletişime geçiniz.'))
        ->assertSee('Canlı Önizleme')
        ->assertSee('Github Repo');
});
